# Configurando a VPS ubuntu 22.04 (VPS Hostgator)
...
ExecStart=/root/apps/algol.dev/.bun/bin/bun run index.ts
Restart=always
RestartSec=3
...
ExecStart=/root/apps/cegesp.algol.dev/.bun/bin/bun run index.ts
Restart=always
RestartSec=3
...
ExecStart=/root/apps/teethgram.algol.dev/.bun/bin/bun run index.ts
Restart=always
RestartSec=3
...
sudo systemctl enable --now cegesp.algol.dev.service
